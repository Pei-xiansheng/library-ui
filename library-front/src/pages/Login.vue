                ...
                <div class="r-info-user">
                    <div class="login-box" v-if="!isRegister">
                        <table>
                            ...
                            <tr>
                                <td style="width: 150px;height: 80px;" colspan="2"><button style="width: 150px;height: 40px;border-radius: 5px;cursor: pointer;" @click="submitLogin()">登录</button></td>
                            </tr>
                        </table>
                    </div>
...
export default {
    data() {
        ...
        isRegister:false,
        //登录左边图片
        imgLeft:'https://edu-guli-apeng.oss-cn-beijing.aliyuncs.com/library/other/donghua.jfif',
        //验证码
    ...
    methods: {
        ...
        submitLogin(){
            ...
            .then(responce=>{
                ...
                cookie.set('user_front_token',responce.data.tokenStr)
            ...
            cookie.set('user_front_Info',JSON.stringify(this.loginInfo))
                this.$message({
                    type: 'success',
                    message: '登录成功!'
                });
...
.main{
    ...
    /* background-image: url('https://edu-guli-apeng.oss-cn-beijing.aliyuncs.com/library/other/dong.jfif'); */
...
.log-box{
    ...
    box-shadow: 10px 10px 10px #f7ebfa;
}
.box-l{
    display: block;
    float: left;
